class Ooui {
  ...
  static const String bold_arab_dad =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="currentColor" d="M5.3 16a7.04 7.04 0 01-1.65-.19 4.27 4.27 0 01-1.38-.58 2.79 2.79 0 01-.93-1.03A3.07 3.07 0 011 12.72a5.4 5.4 0 01.05-.73 6.97 6.97 0 01.19-.89c.1-.33.25-.74.45-1.22l1.95.67-.28.79c-.06.2-.1.37-.12.52a4.3 4.3 0 00-.03.48 1.48 1.48 0 00.91 1.37c.31.14.7.2 1.15.2.4 0 .75-.03 1.05-.1.3-.08.57-.19.78-.34.2-.15.36-.33.47-.56a1.8 1.8 0 00.16-.79c0-.4-.07-.88-.22-1.43a43.94 43.94 0 00-.49-1.72l2.22-.56.2.85a32.58 32.58 0 01.28.96c.06.17.13.31.22.44.1.12.26.22.48.3.22.08.55.14.97.18a22.63 22.63 0 003.28 0 8.45 8.45 0 001.06-.14c.28-.06.5-.14.66-.23a.8.8 0 00.32-.3.73.73 0 000-.74.68.68 0 00-.28-.29 1 1 0 00-.52-.1 2.05 2.05 0 00-.82.18 4.18 4.18 0 00-.84.48 7.54 7.54 0 00-.8.68c-.27.25-.51.5-.75.76l-2.22-.32a14.33 14.33 0 012.01-2.27 8.7 8.7 0 011.16-.87 5.45 5.45 0 011.23-.57c.42-.14.85-.21 1.27-.21.6 0 1.1.12 1.53.37.42.24.75.57.97.98.23.41.35.88.35 1.4a2.72 2.72 0 01-1.29 2.43c-.43.29-1 .51-1.7.67a13.88 13.88 0 01-3.77.17 10 10 0 01-1.32-.18 5.19 5.19 0 01-1.15-.4 1.57 1.57 0 01-.69-.64l.92.5a3.23 3.23 0 01-1.54 2.63 4.9 4.9 0 01-1.49.65A6.29 6.29 0 015.3 16Zm10.39-9.93a1 1 0 01-.72-.3.98.98 0 01-.3-.72c0-.29.1-.53.3-.74.2-.2.44-.31.72-.31s.52.1.71.31c.2.2.3.45.3.74 0 .28-.1.52-.3.72a.95.95 0 01-.71.3Z"/></svg>';
  ...
  static const String italic_arab_keheh_jeem =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="currentColor" d="M6.54 14.24a1.13 1.13 0 01-.83-.35 1.12 1.12 0 01-.33-.82 1.17 1.17 0 011.16-1.19c.32 0 .59.12.8.35.23.23.34.51.34.84 0 .33-.11.6-.33.82a1.06 1.06 0 01-.8.35Zm5.37-2.12c-.6 0-1.16-.04-1.67-.12a3.6 3.6 0 01-1.31-.5A2.81 2.81 0 018 10.44a5.64 5.64 0 01-.47-1.8l1.62-.83c.08.45.2.8.34 1.08.15.26.34.46.57.6.24.13.52.22.85.26.33.04.71.06 1.15.06.41 0 .71.11.9.33.18.21.27.48.27.8 0 .35-.11.63-.34.85-.22.22-.54.33-.98.33ZM6.44 18a7.4 7.4 0 01-2.16-.3 5.05 5.05 0 01-1.73-.9 4.14 4.14 0 01-1.15-1.46 5.47 5.47 0 01-.06-3.96 5.6 5.6 0 01.94-1.6A6.87 6.87 0 013.7 8.51a8.49 8.49 0 011.77-.92A11.26 11.26 0 017.48 7l.1.3a23.61 23.61 0 00-.8-.23 10.23 10.23 0 00-.97-.25 11.74 11.74 0 00-1.1-.2 7.54 7.54 0 00-1.2-.08 8.35 8.35 0 00-1.97.23l-.32-2.33.94-.22a7.7 7.7 0 012.64.06 18.94 18.94 0 012.52.8c.38.15.74.27 1.09.37.34.1.7.15 1.04.15h.67l.25 2.55c-.35 0-.76.05-1.23.15a9.78 9.78 0 00-1.5.43 9.63 9.63 0 00-1.56.7 7.58 7.58 0 00-1.38.94 4.68 4.68 0 00-.99 1.21A2.9 2.9 0 003.35 13c0 .49.09.89.26 1.21.17.34.4.6.7.8a2.89 2.89 0 001.04.46c.4.1.83.15 1.3.15a8.2 8.2 0 001.7-.18 10.61 10.61 0 001.75-.53l.67 2.08c-.76.36-1.52.6-2.28.76a9.78 9.78 0 01-2.05.24Z"/><path fill="currentColor" d="m11.9 12.12.16-2.31h2.2c.18 0 .33-.01.46-.03a.7.7 0 00.33-.12.55.55 0 00.2-.21c.03-.1.05-.2.05-.3 0-.2-.09-.43-.26-.71a5 5 0 00-.82-.94 44.61 44.61 0 00-.66-.6 28.22 28.22 0 00-.66-.58 7.85 7.85 0 01-.49-.48c-.12-.16-.17-.27-.17-.35a5.01 5.01 0 01.11-1.07.74.74 0 01.2-.38c.17-.17.43-.38.8-.62.38-.24.82-.5 1.33-.77a31.05 31.05 0 011.64-.85 39.86 39.86 0 011.77-.8L19 3.02l-1.61.73a26.18 26.18 0 00-1.39.67c-.41.2-.79.41-1.13.62a7.63 7.63 0 00-.86.58l.03-1.24a14.9 14.9 0 011.82 1.56c.48.5.87.96 1.16 1.4a4.2 4.2 0 01.79 2.17 2.25 2.25 0 01-.87 1.75c-.3.25-.72.46-1.23.62a6.7 6.7 0 01-1.94.24H11.9Z"/></svg>';
  ...
  static const String recent_changes_ltr =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><circle cx="2" cy="4" r="2" fill="currentColor"/><circle cx="2" cy="10" r="2" fill="currentColor"/><circle cx="2" cy="16" r="2" fill="currentColor"/><path fill="currentColor" d="M6 3h11v2H6zm0 6h6v2H6zm0 6h2v2H6zm12.76-3.11 1.078-1.112a.556.556 0 000-.783l-1.855-1.833a.556.556 0 00-.783 0l-1.09 1.077 2.65 2.65zm-3.227-2.062L10 15.361V18h2.639l5.533-5.533z"/></svg>';
  static const String recent_changes_rtl =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><circle cx="18" cy="4" r="2" fill="currentColor"/><circle cx="18" cy="10" r="2" fill="currentColor"/><circle cx="18" cy="16" r="2" fill="currentColor"/><path fill="currentColor" d="M14 3H3v2h11zm0 6h-2v2h2zm0 6h-4v2h4zM6.11 9.24l1.113-1.08a.556.556 0 01.783 0l1.833 1.857a.556.556 0 010 .782l-1.078 1.09-2.65-2.65zm2.062 3.226L2.64 18H0v-2.64l5.533-5.532z"/></svg>';
  ...
  static const String user_contributions_ltr =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><circle cx="2" cy="4" r="2" fill="currentColor"/><circle cx="2" cy="10" r="2" fill="currentColor"/><circle cx="2" cy="16" r="2" fill="currentColor"/><circle cx="15.5" cy="10.5" r="2.5" fill="currentColor"/><path fill="currentColor" d="M6 15h3v2H6zm0-6h5v2H6zm0-6h11v2H6zm9.5 10.556c-3.33 0-4.5 1.666-4.5 2.777V18h9v-1.667c0-1.11-1.17-2.777-4.5-2.777z"/></svg>';
  static const String user_contributions_rtl =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><circle cx="18" cy="4" r="2" fill="currentColor"/><circle cx="18" cy="10" r="2" fill="currentColor"/><circle cx="18" cy="16" r="2" fill="currentColor"/><circle cx="4.5" cy="10.5" r="2.5" fill="currentColor"/><path fill="currentColor" d="M14 15h-3v2h3zm0-6H9v2h5zm0-6H3v2h11zM4.5 13.556c-3.33 0-4.5 1.666-4.5 2.777V18h9v-1.667c0-1.11-1.17-2.777-4.5-2.777z"/></svg>';
  ...
  static const String watchlist_ltr =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="currentColor" d="M2 15v2h16v-2zm0-6v2h12V9zm0-6v2h8V3zm16 0h-2.1L15 1l-.9 2H12l1.6 1.8-.5 2.2L15 5.8 16.9 7l-.5-2.2z"/></svg>';
  static const String watchlist_rtl =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="currentColor" d="M18 15v2H2v-2zm0-6v2H6V9zm0-6v2h-8V3zM2 3h2.1L5 1l.9 2H8L6.4 4.9 6.9 7 5 5.8 3.1 7l.5-2.2z"/></svg>';
  ...
  static const String zoom_in =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="currentColor" d="m19 17-5.15-5.15a7 7 0 10-2 2L17 19zM3.5 8A4.5 4.5 0 118 12.5 4.49 4.49 0 013.5 8z"/><path fill="currentColor" d="M11 7.25H8.75V5h-1.5v2.25H5v1.5h2.25V11h1.5V8.75H11z"/></svg>';
  static const String zoom_out =
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="currentColor" d="m19 17-5.15-5.15a7 7 0 10-2 2L17 19zM3.5 8A4.5 4.5 0 118 12.5 4.49 4.49 0 013.5 8z"/><path fill="currentColor" d="M5 7.25h6v1.5H5z"/></svg>';
  List iconsList = [
    add,
    alert,
    align_center,
